        ...
        <div className="flex flex-col gap-y-3">
            ...
            <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                ...
                <div className="grid gap-3">
                    <Card className="w-full h-full border-none bg-blue-50 p-0 rounded-sm">
                        <CardContent className="px-7 py-4">
                            <div className="flex flex-col">
                                ...
                                <Button
                                    variant={"secondary"}
                                    className="w-fit ml-auto rounded-sm bg-blue-50 hover:bg-blue-100 text-blue-500 hover:text-blue-600"
